...
conda: download_bash_environment_manager
	@sudo bash .tmp/bash-environment-manager-master/types/reposet/assemble.sh $(APPNAME) $(SUDO_USER) conda
	@sudo bash .tmp/bash-environment-manager-master/types/reposet/emit/emit_activate.sh $(APPNAME) $(SUDO_USER) conda
	@sudo bash .tmp/bash-environment-manager-master/types/reposet/ops/conda.sh $(APPNAME) $(SUDO_USER) conda
